...
import { PetsModalTypes } from "./OwnersTablePetsModalTypes";

const OwnersTablePetsModal: React.FC<PetsModalTypes> = ({
  pets,
  ownerFullName,
  dataTarget,
  navigate,
      ...
      <div className="modal-dialog modal-dialog-centered modal-xl">
        <div className="modal-content">
          ...
          <div className="modal-body p-2">
            <h5 className="modal-title mb-2">Pets</h5>
...
export default OwnersTablePetsModal;
