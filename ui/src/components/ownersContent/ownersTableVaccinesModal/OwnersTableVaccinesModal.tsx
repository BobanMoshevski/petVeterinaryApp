...
import { VaccinesModalTypes } from "./OwnersTableVaccinesModalTypes";

const OwnersTableVaccinesModal: React.FC<VaccinesModalTypes> = ({
  pets,
  dataTarget,
  ownerFullName,
  navigate,
          ...
          <div className="modal-body p-2">
            <div className="table-horizontal-scroll">
              {pets.map((pet: PetType) => (
                <Fragment key={`petVaccines${pet.id}`}>
                  <h5 className="mb-2">Pet Name: {pet.name}</h5>
                  <table className="table table-bordered border-secondary table-hover mb-2">
                    <thead>
                      <tr>
...
export default OwnersTableVaccinesModal;
