...
import OwnerDetailsPetsTableVaccinesModal from "../ownerDetailsPetsTableVaccinesModal/OwnerDetailsPetsTableVaccinesModal";
import { PetsTableType } from "./OwnerDetailsPetsTableTypes";
import { PetType } from "../../../models/PetTypes";

const OwnerDetailsPetsTable: React.FC<PetsTableType> = ({
  navigate,
  pets,
}: PetsTableType) => {
  return (
              ...
              <td className="text-center align-middle">
                {pet.vaccines.length === 0 ? (
                  ...
                  <div className="d-flex justify-content-center align-items-center">
                    ...
                    <OwnerDetailsPetsTableVaccinesModal
...
export default OwnerDetailsPetsTable;
