...
import { OwnerDetailsPetsTableVaccinesModalTypes } from "./OwnerDetailsPetsTableVaccinesModalTypes";
import { VaccineType } from "../../../models/VaccineTypes";

const OwnerDetailsPetsTableVaccinesModal: React.FC<
  OwnerDetailsPetsTableVaccinesModalTypes
> = ({
  dataTarget,
  vaccines,
  petName,
...
export default OwnerDetailsPetsTableVaccinesModal;
